 ...
 */
public class VAdmPaginaPrincipalAdmin extends javax.swing.JFrame {

    /**
     * Creates new form InicioAdministrador
     */
    public VAdmPaginaPrincipalAdmin() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 110, -1, -1));

        lblTitulo.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        lblTitulo.setForeground(new java.awt.Color(51, 51, 51));
        lblTitulo.setText("BIENVENIDO ADMINISTRADOR");
        getContentPane().add(lblTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 40, -1, -1));

        btnAlumno1.setBackground(new java.awt.Color(178, 226, 226));
        btnAlumno1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Desing/UserCircle.png"))); // NOI18N
        btnAlumno1.setText("Alumno");
        btnAlumno1.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btnAlumno1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAlumno1ActionPerformed(evt);
            }
        });
        getContentPane().add(btnAlumno1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, 180, 40));
        ...
        getContentPane().add(btnProfesor, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 210, 180, 40));
        ...
        getContentPane().add(btnHorario, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 420, 180, 40));
        ...
        getContentPane().add(btnMateria, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 280, 180, 40));
        ...
        getContentPane().add(btnGrupo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 350, 180, 40));
        ...
        getContentPane().add(btnCerrarSesion, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 490, 180, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VAdmPaginaPrincipalAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VAdmPaginaPrincipalAdmin().setVisible(true);
            }
        });
    }
